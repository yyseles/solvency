...
(function(){
  ...
  function capArr(ent, capMetric){
    ...
    if(ent.src==='sun'){ const o=(D.raw[capMetric]&&D.raw[capMetric][ent.block]&&D.raw[capMetric][ent.block][ent.company])||{}; return D.periods.map(p=>o[p]==null?null:o[p]); }
